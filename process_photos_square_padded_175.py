...
if __name__ == "__main__":
    ...
    for rownum, row in enumerate(db_data):
        ...
        image_padded = process_image(image)
    ...
    print("Saving data...")
    with open(capstone_folder + "pickled_images_labels/images_padded_175.pkl", 'wb') as f:
    ...
    with open(capstone_folder + "pickled_images_labels/cnn_image_size_175.pkl", 'wb') as f:
